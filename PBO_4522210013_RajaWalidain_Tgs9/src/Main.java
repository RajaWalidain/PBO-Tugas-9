...
public class Main {
    public static void main(String[] args) {
        ...
        CPU.Motherboard motherboard = myComputer.new Motherboard("B660M", "Lenovo");

        // Create a PowerSupply object
        CPU.PowerSupply powerSupply = myComputer.new PowerSupply(750, "Armaggeddon");

        // Create a VGACard object
        CPU.VGACard vgaCard = myComputer.new VGACard("RTX 3080", 8, "RTX");
